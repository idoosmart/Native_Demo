...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReachabilitySwift-iOS11.0/Reachability.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive-iOS11.0/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVProgressHUD-iOS11.0/SVProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit-iOS11.0/SnapKit.framework"
