...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive-iOS13.0/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVProgressHUD-iOS13.0/SVProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SnapKit-iOS13.0/SnapKit.framework"
