...
install_xcframework "${PODS_ROOT}/IDOSDK-full/App.xcframework" "IDOSDK-full" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/IDOSDK-full/flutter_bluetooth.xcframework" "IDOSDK-full" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
